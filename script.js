...
function tapLove(id) {
  ...
  if (loveTaps.size === 4) {
    Swal.fire({
      ...
      typeWriterEffect(
        `Chúc ${userName} “em bé” của anh có một ngày lễ Thiếu nhi thật nhiều niềm vui💕. Đây là một lời chúc muộn của anh do đã chậm trễ trong việc tìm ra tình yêu của đời mình💏. Hãy tha thứ cho anh vì không thể gửi những lời chúc này vào những năm trước nhé, để em bé của anh thiệt thòi rồi! Yêu em! 💘`,
        'loveMsg',
        () => {
          const fromTag = document.createElement("div");
          fromTag.id = 'fromTag';
          fromTag.textContent = "From: Dương";
